...
void CHyperLink::SetDefaultCursor()
{
	...
	{
//		g_hLinkCursor = AfxGetApp()->LoadOEMCursor(OIC_HAND);
...
IMPLEMENT_DYNAMIC(CMailLink,CHyperLink)

BEGIN_MESSAGE_MAP(CMailLink,CHyperLink)
    //{{AFX_MSG_MAP(CMailLink)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()


CMailLink::CMailLink() :CHyperLink()
{
}
