...
/** We need some way to get the names of all the device names
 * */


int test_manipulating_drive(char * device_name) {
	printf("tray was closed: %s\n", cdripper_close_cd_tray(device_name)
			== PR_SUCCESS ? "y" : "n") ;
