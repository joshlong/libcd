...
#ifndef ENCODERDOSXING_H_INCLUDED
#define ENCODERDOSXING_H_INCLUDED

#include "EncoderDos.h"

class CEncoderDosXing:public CEncoderDos
{
public:
	// CONSTRUCTOR
	CEncoderDosXing();
...
#endif /* ENCODERDOSXING_H_INCLUDED */
