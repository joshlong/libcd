	...
	{	psf_binheader_readf (psf, "m", &marker) ;
		...
		{	case FORM_MARKER :
			...
			case SSND_MARKER :
					...
					psf_fseek (psf->filedes, psf->dataoffset + psf->datalength, SEEK_SET) ;
					break ;
			...
			case INST_MARKER :
					...
					/*-psf_binheader_readf (psf, "j", SIZEOF_INST_CHUNK - 6 - 2 -6) ;-*/
					break ;
...
{	static char inst_data [0x14] =
	{	0x3C, 0x00, 0x00, 0x7F, 0x01, 0x7F, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00, 0x04
		} ;
	int		k ;
	...
	{	/* Add test INST chunk. */
		psf_binheader_writef (psf, "Em4b", INST_MARKER, 0x14, inst_data, 0x14) ;
		} ;
