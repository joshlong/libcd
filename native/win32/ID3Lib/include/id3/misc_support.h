// -*- C++ -*-
// $Id: misc_support.h 591 2007-01-01 19:15:10Z afaber $
...
// CDEX SPECIFIC ADDITIONS
ID3_C_EXPORT char*      ID3_GetEncodedBy(const ID3_Tag*);
ID3_C_EXPORT ID3_Frame* ID3_AddEncodedBy(ID3_Tag*, const char*, bool replace = false);
ID3_C_EXPORT size_t     ID3_RemoveEncodedBy(ID3_Tag*);

ID3_C_EXPORT char *ID3_GetSongLen(const ID3_Tag *tag);
ID3_C_EXPORT ID3_Frame* ID3_AddSongLen(ID3_Tag *tag, const char *text, bool bReplace);
ID3_C_EXPORT size_t ID3_RemoveSongLen(ID3_Tag *tag);

ID3_C_EXPORT char*      ID3_GetMCDI(const ID3_Tag*);
ID3_C_EXPORT size_t ID3_RemoveMCDI(ID3_Tag *tag);
ID3_C_EXPORT ID3_Frame* ID3_AddMCDI(ID3_Tag *tag, const char *text, bool bReplace);
// END CDEX SPECIFIC ADDITIONS
