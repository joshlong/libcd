...
#ifndef ENCODERAPEDLL_H_INCLUDED
#define ENCODERAPEDLL_H_INCLUDED

#include "Encode.h"

#undef DLLEXPORT
#include "./libraries/libape/MACDll.h"

class CEncoderApeDll : public CEncoder
{
private:
	HINSTANCE			m_hDLL;
	CUString				m_strStreamFileName;
	APE_COMPRESS_HANDLE m_hAPECompress;
	BOOL				m_bWriteTag ;
